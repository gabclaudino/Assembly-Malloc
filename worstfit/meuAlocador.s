...
.loop:
    ...
    cmpq 8(%r11), %r15              # verifica se o tamanho é o maior possível
    jge .proximo                    # se não for maior, vai para o próximo
    movq 8(%r11), %r15              # salva o novo maior tamanho encontrado
